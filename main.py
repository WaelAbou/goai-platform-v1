...
app.include_router(esg_companion.router, prefix="/api/v1/companion", tags=["ESG Companion"])
app.include_router(conversations.router, prefix="/api/v1/conversations", tags=["Platform Conversations"])
